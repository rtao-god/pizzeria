...
import styles from './PreviewFood.module.sass'
...
export default function PreviewFood() {
    ...
    return (
        <>
            ...
            <div className={styles.previewFood}>
                <div className={styles.previewFoodContainer}>
                    <img
                        className={styles.previewFoodImg}
                        src={'/photo/food/' + selectedFood.img + '-optimize.jpg'}
                        alt="food"
                        onClick={handleImageClick}
                        style={imgFoodStyle}
                    />
                    <div className={styles.previewFoodContent}>
                        <div className={styles.previewFoodContentTwo}>
                            <div className={styles.previewFoodContainerFlex}>
                                <h4 className={styles.previewFoodTitle}> {selectedFood.title} </h4>
                                <p> icon </p>
                            </div>
                            <p className={styles.previewFoodDescription}> {selectedFood.ingredients} </p>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className={styles.dropdown}>
                                    <div className={styles.addToppings}>
                                        <p> Add more toppings </p>
                                        <span> {'>'} </span>
                                    </div>
                                    <div className={styles.dropdownContent}>
                                        <div
                                            className={styles.toppingsType}
                                            ref={toppingsTypeRef}
                            ...
                            <input
                                ...
                                readOnly
                            />
                            <div className={styles.cheese} onClick={cheeseFunc}>
                                <input type="checkBox" />
                                <span>
