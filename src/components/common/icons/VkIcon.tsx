...
export default function VkIcon({ className }: VkIconProps) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px">
            <linearGradient
                id="kgRuRVfhYbsg7F4Xxd2wXa"
                x1="32"
                x2="32"
                y1="-1703.5"
                y2="-1757.251"
            ...
            <path
                fill="url(#kgRuRVfhYbsg7F4Xxd2wXa)"
            ...
            <path
                fill="url(#kgRuRVfhYbsg7F4Xxd2wXb)"
