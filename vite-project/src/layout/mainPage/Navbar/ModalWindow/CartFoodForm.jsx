...
export default function CartFoodForm({ getDefaultPrice, bas, basket, increase, decrement }) {
    useEffect(() => {
    ...
    return (
        <div className={cl.cartFood}>
            <img className={cl.miniFoodImg} src={"/photo/food/" + bas.img + "-optimize.jpg"} alt="Your basket" />
