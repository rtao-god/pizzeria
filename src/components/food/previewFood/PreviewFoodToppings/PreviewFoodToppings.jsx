...
import styles from './PreviewFoodToppings.module.sass'
...
export default function PreviewFoodToppings({ toppingsEl }) {
    ...
    return (
        <dl className={styles.cardToppings}>
            <dd>
                <img src={'/photo/toppings/' + toppingsEl.img + '.png'} alt="toppings icon" />
            </dd>
            <dd className={styles.title}> {toppingsEl.title} </dd>
            <dd className={styles.price}> {toppingsEl.price} $ </dd>
